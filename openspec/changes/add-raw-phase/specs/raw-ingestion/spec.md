...
- **WHEN** an inspector greps `commands/raw/`, `agents/raw-classifier.md`, and `skills/raw-*/` for "apilize", "wertxpert", "intreal", or any other client/product name from past APZ usage
